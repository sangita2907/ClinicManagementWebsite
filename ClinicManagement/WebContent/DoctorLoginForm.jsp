...
<body>
    ...
    <div class="box">
        ...
        <br><br>
        <form class="form" action="DoctorLogin" method="post">
            <div>
                <div class="label">
                    <label for="email">E-mail</label>
                </div>
                <div class="input">
                    <input type="email" name="demail" id="email" placeholder="Enter email" required>
                </div>
            </div>
            ...
            <div>
                ...
                <div class="input">
                    <input type="password" name="dpass" id="pass" placeholder="password" required>
                </div>
            </div>
