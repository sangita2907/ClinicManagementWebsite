...
<body>
    ...
    <div class="container">
    <%
    	String searchElement = (request.getParameter("search")).toLowerCase();
    ...
    %>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                	<%
                		//logic of searching by specialization
                		if(searchElement.equals((doctor.getSpecialist()).toLowerCase())){ 
                		isFound = true;
                	%>
                ...
                <% if (isFound == false) {%>
                	<tr>
                		<td colspan="4"><p style="color: red; font-size: 25px;">No doctors available..</p></td>
					</tr>
				<% } %>
            </tbody>
        </table>
